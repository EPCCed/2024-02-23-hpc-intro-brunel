...
```bash
userid@uan01:/work/ta133/ta133/userid> squeue -u userid
```
...
```bash
userid@uan01:/work/ta133/ta133/userid> sbatch --partition=standard --qos=short example-job.sh
userid@uan01:/work/ta133/ta133/userid> watch -n 15 squeue -u userid
```
...
```bash
userid@uan01:/work/ta133/ta133/userid> cat example-job.sh
```
...
```bash
userid@uan01:/work/ta133/ta133/userid> sbatch example-job.sh
userid@uan01:/work/ta133/ta133/userid> watch -n 15 squeue -u userid
```


```bash
userid@uan01:/work/ta133/ta133/userid> cat slurm-38193.out
```
...
```bash
userid@uan01:/work/ta133/ta133/userid> scancel 38759
...
```bash
userid@uan01:/work/ta133/ta133/userid> sbatch run-pi-mpi.slurm
```
