...
**Using wget**: 
```bash
userid@ln03:~> wget https://epcced.github.io/2023-12-15-noc-hpcintro/files/hpc-intro-data.tar.gz
```

**Using a web browser**: 

[https://epcced.github.io/2023-12-15-noc-hpcintro/files/hpc-intro-data.tar.gz](https://epcced.github.io/2023-12-15-noc-hpcintro/files/hpc-intro-data.tar.gz)
:::
...
or
```bash
[user@laptop ~]$ wget https://epcced.github.io/2023-12-15-noc-hpcintro/files/hpc-intro-data.tar.gz
```
...
userid@ln03:~> curl -O https://epcced.github.io/2023-12-15-noc-hpcintro/files/hpc-intro-data.tar.gz
or
userid@ln03:~> wget https://epcced.github.io/2023-12-15-noc-hpcintro/files/hpc-intro-data.tar.gz
```
